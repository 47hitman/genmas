...
class SusunKataScreen extends StatefulWidget {
  const SusunKataScreen({Key? key}) : super(key: key);

  @override
  _SusunKataScreenState createState() => _SusunKataScreenState();
}

class _SusunKataScreenState extends State<SusunKataScreen> {
